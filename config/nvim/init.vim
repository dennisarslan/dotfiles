...
" deoplete stuff
  ...
  call dein#add('artur-shaik/vim-javacomplete2') "slow
  call dein#add('Shougo/neco-vim')
  call dein#add('Shougo/neoinclude.vim')
  call dein#add('ujihisa/neco-look') "slow
  call dein#add('davidhalter/jedi-vim', {'on_ft': 'python'}) "slow
  call dein#add('zchee/deoplete-jedi')
  call dein#add('zchee/nvim-go', {'build': 'gb build', 'on_ft': 'go'})
  call dein#add('zchee/deoplete-go')
  call dein#add('junegunn/limelight.vim')
  call dein#add('Konfekt/FastFold')
"  call dein#add('Shougo/neosnippet.vim') "slow
"  call dein#add('Shougo/neosnippet-snippets') "slow
...
" Tabs to double spaces
set tabstop=2 shiftwidth=2 expandtab

autocmd BufNewFile,BufRead Jenkinsfile set filetype=groovy
autocmd BufNewFile,BufRead playbook.yaml call SetAnsibleOptions()
function SetAnsibleOptions()
  "let g:ansible_attribute_highlight = 'ab'
  "let g:ansible_name_highlight = 'ab'
  set ft=ansible
  " hi AnsibleString guifg=#aac863 ctermfg=203 guibg=#fb3006 ctermbg=237
  " hi AnsibleRepeat guifg=#a594c5 ctermfg=176 guibg=#a4ad00 ctermbg=237
  " hi AnsibleConditional guifg=#ac5f67 ctermfg=203 guibg=#c00ccc ctermbg=237
  " hi ansibleRepeat link String
  hi link ansible_conditional Comment
"  hi link ansible_debug_keywords String
" Repeat is lichtoranje
 " hi link ansible_name Repeat
  hi link ansible_special_keywords Comment
  hi link ansible_extra_special_keywords Repeat
  hi link ansible_with_keywords Repeat
  hi link ansible_attribute_highlight rubyAttribute
  hi link ansible_name_highlight Comment
  hi link ansible_name Comment
  highlight link yamlFlowString String
  highlight link yamlBool String
  highlight link yamlFlowString String
  highlight link yamlFlowStringDelimiter Delimiter
  highlight link jinjaVariable String
  highlight link jinjaVarDelim Delimiter
  highlight link ansible_attributes Structure
  highlight link ansible_attribute Structure
...
set guifont=Sauce\ Code\ Pro\ for\ Powerline:h12
